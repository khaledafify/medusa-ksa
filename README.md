...
| **Payments** | | | |
| `medusa-payment-moyasar` | [`payments/moyasar`](./packages/payments/moyasar) | Moyasar — hosted redirect + Moyasar.js; Mada, cards, Apple Pay, STC Pay, Samsung Pay _(reference connector)_ | ✅ Stable |
...
| **Compliance & tooling** | | | |
| `medusa-plugin-zatca` | [`zatca`](./packages/zatca) | **ZATCA / Fatoora Phase 2** e-invoicing — Simplified (B2C) reporting, signed UBL + QR _(flagship; B2B clearance & multi-EGS planned)_ | 🚧 Beta |
